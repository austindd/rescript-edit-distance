...
function damerau_levenshtein(maxLength, _first, _second) {
...
function damerau_levenshtein_2(maxLength, _first, _second) {
...
function damerau_levenshtein_3(maxLength, _first, _second) {
  var l1 = _first.length;
  var l2 = _second.length;
  var match = l1 > l2 ? [
      _second,
...
function damerau_levenshtein_4(maxLength, _first, _second) {
  var l1 = _first.length;
  var l2 = _second.length;
  var first = l1 > l2 ? _second : _first;
  var firstLength = l1 > l2 ? l2 : l1;
  var second = l1 > l2 ? _first : _second;
  var secondLength = l1 > l2 ? l1 : l2;
  if (firstLength === 0) {
    return secondLength;
  }
  if (secondLength === 0) {
...
exports.damerau_levenshtein_2 = damerau_levenshtein_2;
exports.damerau_levenshtein_3 = damerau_levenshtein_3;
exports.damerau_levenshtein_4 = damerau_levenshtein_4;
/* No side effect */
